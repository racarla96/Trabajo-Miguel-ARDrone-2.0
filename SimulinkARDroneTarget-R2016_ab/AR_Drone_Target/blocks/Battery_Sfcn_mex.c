 ...
 *    C source code generated on : 27-Apr-2022 17:44:29
 *
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "BatteryMeasure_start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "BatteryMeasure_step", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "BatteryMeasure_term", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
