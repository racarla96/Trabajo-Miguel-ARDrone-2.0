 ...
 *
 *         int32 y1 = udp_recv(int32 u1, double u2, uint8 y2[32])
 *
 *    Simulink version           : 8.8 (R2016b) 25-Aug-2016
 *    C source code generated on : 27-Apr-2022 17:44:30
 *
...
#define S_FUNCTION_NAME  UDP_Recv_Sfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "udp_recv", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "udp_recv_close", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
